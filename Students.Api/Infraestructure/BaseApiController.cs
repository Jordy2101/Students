...
namespace Students.Api.Infraestructure
{

    [ApiController]
    [Route("api/[controller]")]
    public class BaseApiController<TEntity, TDto, TManager> : Controller where TEntity : BaseEntity where TManager : IServicesBase<TEntity>
    {
